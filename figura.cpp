...
void figura::mov_rotar(int numero)
{
    ...
    if (numero == 1)
    {
        Serial.println("hola 1111111111111111");
        if (rotacion == 2)
        {
            arrayY[1] = y + 1;
            arrayX[1] = x;
    ...
    if (numero == 2)
    {
        Serial.println("numerooooooooooooooooooooooo 22222");
        if (rotacion == 2)
        {
            arrayY[1] = y;
            arrayX[1] = x - 1;
    ...
    if (numero == 3)
    {
        Serial.println("numerooooooooooooooooooooooo 3");
        if (rotacion == 2)
        {
            arrayY[1] = y;
            arrayX[1] = x - 1;
    ...
    if (numero == 5)
    {
        ...
        if (rotacion == 2)
        {
            ...
            Serial.println("hollllllllllllllaaaaaaaaaaaaaaaaa");
            arrayY[1] = y + 1;
            arrayX[1] = x;
            arrayY[2] = y + 1;
            arrayX[2] = x - 1;
